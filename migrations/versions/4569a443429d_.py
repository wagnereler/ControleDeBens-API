...
Revision ID: 4569a443429d
Revises: 
Create Date: 2024-01-19 17:38:24.164903
...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('ddi', sa.String(length=4), server_default=sa.text("'+55'::character varying"), nullable=False),
