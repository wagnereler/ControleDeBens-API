...
Revision ID: 55e3c808dff8
Revises: 1fdeebf0b9c8
Create Date: 2024-01-19 17:49:40.491995
...
revision = '55e3c808dff8'
down_revision = '1fdeebf0b9c8'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    sa.ForeignKeyConstraint(['id_empresa'], ['empresa.id'], name='log_acesso_id_empresa_fkey'),
    sa.ForeignKeyConstraint(['id_usuario'], ['usuario.id'], name='log_acesso_id_usuario_fkey'),
    sa.PrimaryKeyConstraint('id', name='log_acesso_pkey')
    )
