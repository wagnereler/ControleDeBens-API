...
Revision ID: 7956a0ce948c
Revises: 
Create Date: 2024-01-29 18:12:15.798303
...
def upgrade_metadado():
    ...
    sa.Column('responsavel', sa.String(length=40), nullable=False),
    sa.Column('data_atualizacao', sa.Date(), nullable=False),
    sa.PrimaryKeyConstraint('id'),
