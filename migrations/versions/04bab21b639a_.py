...
Revision ID: 04bab21b639a
Revises: 
Create Date: 2024-01-30 13:16:43.352061
...
def upgrade_():
    ...
    sa.Column('status', sa.Integer(), nullable=False, comment='1 = Sucesso, 2 = Falha, 3 = Não autorizado'),
    sa.ForeignKeyConstraint(['id_empresa'], ['empresa.id'], ),
    sa.ForeignKeyConstraint(['id_rotina'], ['rotina.id'], ),
    sa.ForeignKeyConstraint(['id_usuario'], ['usuario.id'], ),
    sa.PrimaryKeyConstraint('id')
...
def upgrade_metadados():
    ...
    op.create_table('controle_versao',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    ...
    sa.Column('data_commit', sa.Date(), nullable=False),
