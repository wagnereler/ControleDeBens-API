...
Revision ID: 6a1ddc499d6f
Revises: 
Create Date: 2024-01-15 20:10:37.364772
...
def upgrade():
    ...
    sa.Column('codigo_ibge', sa.String(length=2), nullable=True),
    ...
    with op.batch_alter_table('logradouro', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_logradouro_id'), ['id'], unique=False)
        batch_op.create_index(batch_op.f('ix_logradouro_nome'), ['nome'], unique=False)

    op.create_table('papel',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('id_rotina', sa.Integer(), nullable=True),
    ...
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('ddi', sa.String(length=4), server_default=sa.text("'+55'::character varying"), nullable=True),
    sa.Column('dd', sa.String(length=2), nullable=True),
    ...
    sa.Column('codigo_ibge', sa.String(length=8), nullable=True),
    ...
    sa.Column('id_telefone', sa.Integer(), nullable=True),
    ...
    sa.Column('empresa_id1', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['id_empresa'], ['empresa.id'], ),
    ...
    sa.Column('id_setor_saida', sa.Integer(), nullable=False),
    sa.Column('id_setor_entrada', sa.Integer(), nullable=False),
    sa.Column('id_empresa_saida', sa.Integer(), nullable=False),
    sa.Column('id_empresa_entrada', sa.Integer(), nullable=False),
    sa.Column('id_usuario', sa.Integer(), nullable=False),
...
def downgrade():
    ...
    with op.batch_alter_table('logradouro', schema=None) as batch_op:
        ...
        batch_op.drop_index(batch_op.f('ix_logradouro_id'))
